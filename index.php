...
$users = array(
    "xdbilal" => array("name" => "xdbilal", "role"=> "admin"),
...
if(!isset($_SESSION['logged']) || $_SESSION['logged'] ==  false){
    ...
    $loginerror = "!! Enter Password To Use Bot !!";
...
CURLOPT_USERAGENT => '{* Created By BILAL ASHRAF *}',
...
alert("INFO : Your Written Comment Has Been Saved !! Good Luck !!")
...
alert("INFO : Script Comment Has Been Saved !! Good Luck !!")
...
Welcome to Bilal Reaction Site '.$nm.'</br> Your Token Save And Start Bot Working
...
<a target="_blank" href="http://www.facebook.com/100011308998782"><img src="https://graph.facebook.com/100011308998782/picture?type=large" style="width:80px; height:80px;border: 2px;border-radius: 50%;" alt="BILAL" title="BILAL" class="thumbnail"/></a>
<br> </br>

<div id="center">

<a href="http://BILALTOKEN.TK" target="_blank"><input class="button" type="button" value="Get Token"> </a> <a href="http://www.facebook.com/100011308998782" target="_blank"><input class="button" type="button" value="Meet Admin"></a></center>
